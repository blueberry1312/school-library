...
This project is a Ruby program to manage books from a school library, using OOP principles.
...
- Implemented Person, Student and Teacher classes.
...
```sh
  git clone https://github.com/blueberry1312/school-library.git
  cd school-library
```
